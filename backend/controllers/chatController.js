...
export const analyzeSymptoms = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to process symptoms with AI. Please try again.', details: error ? String(error.message || error) : 'Unknown error', stack: error ? String(error.stack) : '' })
    }
}
